...
class Model:
    ...
    def _create_model(self, model_arch, seed):
        ...
        model.append(self._ModelLayer(first_layer_W, first_layer_act_fct, first_layer_act_fct_der, first_layer_name))
        ...
        for cur_layer in range(2, no_layers_plus_input):
            ...
            model.append(self._ModelLayer(cur_layer_W, cur_layer_act_fct, cur_layer_act_fct_der, cur_layer_name))
        return model
