...
class TestModel(unittest.TestCase):
    def test_two_inputs_one_output(self):
        data = pd.read_csv(os.path.dirname(os.path.abspath(__file__)) + '\data_100_2_B_1.csv')
        ...
        val_evaluate =  mod.evaluate(X,Y)
        print("loss: ", val_evaluate['loss'])
        print("accuracy: ", val_evaluate['accuracy'])
        ...
        for ex in val_evaluate['failed_list']:
